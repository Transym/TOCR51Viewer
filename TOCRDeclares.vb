...
#Region " Structures "
    ...
    Public Structure TOCRLANGUAGEOPTIONS_EG
        ...
        'Public DisableCharW() As Byte
        ' 608 bytes
        <VBFixedArray(45), MarshalAs(UnmanagedType.ByValArray, SizeConst:=46)> _
...
#Region " Declares "
    ...
    '    Declare Function TOCRInitialise Lib "TOCRDll64d" _
    '            (ByRef JobNo As Integer) As Integer

    '        Declare Function TOCRShutdown Lib "TOCRDll64d" _
    '            (ByVal JobNo As Integer) As Integer

    '        Declare Function TOCRDoJob_EG Lib "TOCRDll64d" _
    '                (ByVal JobNo As Integer, ByRef JobInfo_EG As TOCRJOBINFO_EG) As Integer

    '        Declare Function TOCRDoJobPDF_EG Lib "TOCRDll64d" _
    ...
    '        Declare Function TOCRWaitForJob Lib "TOCRDll64d" _
    '            (ByVal JobNo As Integer, ByRef JobStatus As Integer) As Integer

    '        Declare Function TOCRWaitForAnyJob Lib "TOCRDll64d" _
    '            (ByRef WaitAnyStatus As Integer, ByRef JobNo As Integer) As Integer

    '        Declare Function TOCRGetJobDBInfo Lib "TOCRDll64d" _
    '            (ByVal JobSlotInf As System.IntPtr) As Integer

    '        Declare Function TOCRGetJobStatus Lib "TOCRDll64d" _
    '            (ByVal JobNo As Integer, ByRef JobStatus As Integer) As Integer

    '        Declare Function TOCRGetJobStatusEx2 Lib "TOCRDll64d" _
    ...
    '        Declare Ansi Function TOCRPopulateCharStatusMap Lib "TOCRDll64d" _
    ...
    '    Declare Ansi Function TOCRConvertFormat Lib "TOCRDll64d" _
    ...
    '    Declare Ansi Function TOCRSetConfigStr Lib "TOCRDll64d" _
    '        (ByVal JobNo As Integer, ByVal Parameter As Integer, ByVal Value As String) As Integer
    '    Declare Ansi Function TOCRGetConfigStr Lib "TOCRDll64d" _
    ...
    '    Declare Ansi Function TOCRGetFontName Lib "TOCRDll64d" _
    '        (ByVal JobNo As Integer, ByVal FontID As Integer, ByVal FontName As System.Text.StringBuilder) As Integer

    '    Declare Ansi Function TOCRExtraInfGetMMF Lib "TOCRDll64d" _
    '        (ByVal JobNo As Integer, ByVal ExtraInfFlag As Integer, ByRef MMF As System.IntPtr) As Integer

    '    Declare Function TOCRTWAINAcquire Lib "TOCRDll64d" _
    '        (ByRef NumberOfImages As Integer) As Integer

    '    Declare Function TOCRTWAINGetImages Lib "TOCRDll64d" _
    '        (ByVal GlobalMemoryDIBs As System.IntPtr) As Integer

    '    Declare Function TOCRTWAINSelectDS Lib "TOCRDll64d" _
    '        () As Integer

    '    Declare Function TOCRTWAINShowUI Lib "TOCRDll64d" _
    '        (ByVal Show As Short) As Integer

    '    #Else
    '        'Debug and Win32 version
    '        Declare Function TOCRInitialise Lib "TOCRDll32d" _
    '            (ByRef JobNo As Integer) As Integer

    '        Declare Function TOCRShutdown Lib "TOCRDll32d" _
    '            (ByVal JobNo As Integer) As Integer

    '        Declare Function TOCRDoJob_EG Lib "TOCRDll32d" _
    '            (ByVal JobNo As Integer, ByRef JobInfo_EG As TOCRJOBINFO_EG) As Integer

    '        Declare Function TOCRDoJobPDF_EG Lib "TOCRDll32d" _
    '            (ByVal JobNo As Integer, ByRef JobInfo_EG As TOCRJOBINFO_EG, ByVal Filename As String, ByRef PDFOpts As TOCRPROCESSPDFOPTIONS_EG) As Integer

    '        Declare Function TOCRWaitForJob Lib "TOCRDll32d" _
    '            (ByVal JobNo As Integer, ByRef JobStatus As Integer) As Integer

    '        Declare Function TOCRWaitForAnyJob Lib "TOCRDll32d" _
    '            (ByRef WaitAnyStatus As Integer, ByRef JobNo As Integer) As Integer

    '        Declare Function TOCRGetJobDBInfo Lib "TOCRDll32d" _
    '            (ByVal JobSlotInf As System.IntPtr) As Integer

    '        Declare Function TOCRGetJobStatus Lib "TOCRDll32d" _
    '            (ByVal JobNo As Integer, ByRef JobStatus As Integer) As Integer

    '        Declare Function TOCRGetJobStatusEx2 Lib "TOCRDll32d" _
    '            (ByVal JobNo As Integer, ByRef JobStatus As Integer, ByRef Progress As Single, ByRef AutoOrientation As Integer, ByRef ExtraInfFlags As Integer) As Integer

    '        Declare Ansi Function TOCRGetJobStatusMsg Lib "TOCRDll32d" _
    '            (ByVal JobNo As Integer, ByVal Msg As System.Text.StringBuilder) As Integer

    '        Declare Ansi Function TOCRGetNumPages Lib "TOCRDll32d" _
    '            (ByVal JobNo As Integer, ByVal Filename As String, ByVal JobType As Integer, ByRef NumPages As Integer) As Integer

    '        Declare Function TOCRGetJobResultsEx_EG Lib "TOCRDll32d" _
    '            (ByVal JobNo As Integer, ByVal Mode As Integer, ByRef ResultsInf As Integer, ByVal Bytes As System.IntPtr) As Integer

    '        Declare Ansi Function TOCRGetLicenceInfoEx Lib "TOCRDll32d" _
    '            (ByVal JobNo As Integer, ByVal Licence As String, ByRef Volume As Integer, ByRef Time As Integer, ByRef Remaining As Integer, ByRef Features As Integer) As Integer

    '        Declare Ansi Function TOCRPopulateCharStatusMap Lib "TOCRDll32d" _
    '            (ByRef p_lang_opts As TOCRLANGUAGEOPTIONS_EG, ByRef p_usercharvalid As TOCRCHAROPTIONS_EG) As Integer

    '        Declare Ansi Function TOCRSetConfig Lib "TOCRDll32d" _
    '            (ByVal JobNo As Integer, ByVal Parameter As Integer, ByVal Value As Integer) As Integer
    '        Declare Function TOCRGetConfig Lib "TOCRDll32d" _
    '            (ByVal JobNo As Integer, ByVal Parameter As Integer, ByRef Value As Integer) As Integer

    '     ' Convert a TIF file to a bitmap file
    '    Declare Ansi Function TOCRConvertFormatHelper Lib "TOCRDll32d" _
    '        (ByVal JobNo As Integer, ByVal InputAddr As String, ByVal InputFormat As Integer, ByVal OutputAddr As String, ByVal OutputFormat As Integer, ByVal PageNo As Integer) As Integer

    '    ' Convert a TIF file to a memory mapped file handle
    '    Declare Ansi Function TOCRConvertFormat Lib "TOCRDll32d" _
    '        (ByVal JobNo As Integer, ByVal InputAddr As String, ByVal InputFormat As Integer, ByRef OutputAddr As System.IntPtr, ByVal OutputFormat As Integer, ByVal PageNo As Integer) As Integer



    '    ' These functions can be used to get/set the log file name in x64
    '    Declare Ansi Function TOCRSetConfigStr Lib "TOCRDll32d" _
    '        (ByVal JobNo As Integer, ByVal Parameter As Integer, ByVal Value As String) As Integer
    '    Declare Ansi Function TOCRGetConfigStr Lib "TOCRDll32d" _
    '        (ByVal JobNo As Integer, ByVal Parameter As Integer, ByVal Value As System.Text.StringBuilder) As Integer
    '    ' Deprecated - use StringBuilder rather thsn String
    '  '  Declare Ansi Function TOCRGetConfigStr Lib "TOCRDll" _
    '  '      (ByVal JobNo As Integer, ByVal Parameter As Integer, ByVal Value As String) As Integer

    '    Declare Ansi Function TOCRGetFontName Lib "TOCRDll32d" _
    '        (ByVal JobNo As Integer, ByVal FontID As Integer, ByVal FontName As System.Text.StringBuilder) As Integer

    '    Declare Ansi Function TOCRExtraInfGetMMF Lib "TOCRDll32d" _
    '        (ByVal JobNo As Integer, ByVal ExtraInfFlag As Integer, ByRef MMF As System.IntPtr) As Integer

    '    Declare Function TOCRTWAINAcquire Lib "TOCRDll32d" _
    '        (ByRef NumberOfImages As Integer) As Integer

    '    Declare Function TOCRTWAINGetImages Lib "TOCRDll32d" _
    '        (ByVal GlobalMemoryDIBs As System.IntPtr) As Integer

    '    Declare Function TOCRTWAINSelectDS Lib "TOCRDll32d" _
    '        () As Integer

    '    Declare Function TOCRTWAINShowUI Lib "TOCRDll32d" _
    '        (ByVal Show As Short) As Integer
...
#If RESELLER1 Then
        ...
        Declare Function TOCRInitialise Lib "TOCRRDll" _
        (ByRef JobNo As Integer, ByRef LicNo As ULong) As Integer

        Declare Function TOCRShutdown Lib "TOCRRDll" _
           (ByVal JobNo As Integer) As Integer

        Declare Function TOCRDoJob_EG Lib "TOCRRDll" _
           (ByVal JobNo As Integer, ByRef JobInfo_EG As TOCRJOBINFO_EG) As Integer

        Declare Function TOCRDoJobPDF_EG Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByRef JobInfo_EG As TOCRJOBINFO_EG, ByVal Filename As String, ByRef PDFOpts As TOCRPROCESSPDFOPTIONS_EG) As Integer

        Declare Function TOCRWaitForJob Lib "TOCRRDll" _
           (ByVal JobNo As Integer, ByRef JobStatus As Integer) As Integer

        Declare Function TOCRWaitForAnyJob Lib "TOCRRDll" _
            (ByRef WaitAnyStatus As Integer, ByRef JobNo As Integer) As Integer

        Declare Function TOCRGetJobDBInfo Lib "TOCRRDll" _
            (ByVal JobSlotInf As System.IntPtr) As Integer

        Declare Function TOCRGetJobStatus Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByRef JobStatus As Integer) As Integer

        Declare Function TOCRGetJobStatusEx2 Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByRef JobStatus As Integer, ByRef Progress As Single, ByRef AutoOrientation As Integer, ByRef ExtraInfFlags As Integer) As Integer

        Declare Ansi Function TOCRGetJobStatusMsg Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByVal Msg As System.Text.StringBuilder) As Integer

        Declare Ansi Function TOCRGetNumPages Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByVal Filename As String, ByVal JobType As Integer, ByRef NumPages As Integer) As Integer

        Declare Function TOCRGetJobResultsEx_EG Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByVal Mode As Integer, ByRef ResultsInf As Integer, ByVal Bytes As System.IntPtr) As Integer

        Declare Ansi Function TOCRGetLicenceInfoEx Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByVal Licence As String, ByRef Volume As Integer, ByRef Time As Integer, ByRef Remaining As Integer, ByRef Features As Integer) As Integer

        Declare Ansi Function TOCRPopulateCharStatusMap Lib "TOCRRDll" _
                (ByRef p_lang_opts As TOCRLANGUAGEOPTIONS_EG, ByRef p_usercharvalid As TOCRCHAROPTIONS_EG) As Integer

        ' These functions cannot be used to get/set the log file name in x64
        Declare Function TOCRSetConfig Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByVal Parameter As Integer, ByVal Value As Integer) As Integer
        Declare Function TOCRGetConfig Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByVal Parameter As Integer, ByRef Value As Integer) As Integer

        ' Convert a TIF or PDF file to a memory mapped file handle
        Declare Ansi Function TOCRConvertFormat Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByVal InputAddr As String, ByVal InputFormat As Integer, ByRef OutputAddr As System.IntPtr, ByVal OutputFormat As Integer, ByVal PageNo As Integer) As Integer

        ' Convert a TIF or PDF file to a bitmap file
        Declare Ansi Function TOCRConvertFormatHelper Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByVal InputAddr As String, ByVal InputFormat As Integer, ByVal OutputAddr As String, ByVal OutputFormat As Integer, ByVal PageNo As Integer) As Integer


        ' These functions can be used to get/set the log file name in x64
        Declare Ansi Function TOCRSetConfigStr Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByVal Parameter As Integer, ByVal Value As String) As Integer
        Declare Ansi Function TOCRGetConfigStr Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByVal Parameter As Integer, ByVal Value As System.Text.StringBuilder) As Integer
        ' Deprecated - use StringBuilder rather thsn String
        ' Declare Ansi Function TOCRGetConfigStr Lib "TOCRRDll" _
        '    (ByVal JobNo As Integer, ByVal Parameter As Integer, ByVal Value As String) As Integer

        Declare Ansi Function TOCRGetFontName Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByVal FontID As Integer, ByVal FontName As System.Text.StringBuilder) As Integer

        Declare Ansi Function TOCRExtraInfGetMMF Lib "TOCRRDll" _
            (ByVal JobNo As Integer, ByVal ExtraInfFlag As Integer, ByRef MMF As System.IntPtr) As Integer

        Declare Function TOCRTWAINAcquire Lib "TOCRRDll" _
            (ByRef NumberOfImages As Integer) As Integer

        Declare Function TOCRTWAINGetImages Lib "TOCRRDll" _
            (ByVal GlobalMemoryDIBs As System.IntPtr) As Integer

        Declare Function TOCRTWAINSelectDS Lib "TOCRRDll" _
            () As Integer

        Declare Function TOCRTWAINShowUI Lib "TOCRRDll" _
            (ByVal Show As Short) As Integer
#Else
    'Release Win32 and Win64 version
